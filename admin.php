                    ...
                    <tr>
                        ...
                        <form action="" method="POST">
                            ...
                            <td style="display:flex; column-gap:10px">
                                <a onclick="confirmDelete(<?= $request->id ?>)"
                                ...
                                function confirmDelete(id) {
                                    var confirmed = confirm("Are you sure you want to delete this request?");
                                    if (confirmed) {
                                        var password = prompt("Please enter your password:");
                                        if (password !== null) {
                                            window.location.href = "delete.php?id=" + id + "&password=" +
...
<script>
function confirmDelete(id) {
    var confirmed = confirm("Bạn có chắc xóa không ?");
    if (confirmed) {
        var password = prompt("Nhập mật khẩu:");
        if (password !== null) {
            window.location.href = "delete.php?id=" + id + "&password=" + encodeURIComponent(password);
        }
    }
}
</script>
