...
class RequestManager
{
    ...
    {
        $sql = 'SELECT * FROM `support-request`';
...
// Sử dụng class để lấy dữ liệu sản phẩm
...
<body>
    <main class="table">
        <section class="table__header">
            <h1 style="display:flex; align-items:center">Danh sách DatSup</h1>
        </section>
        <section class="table__body">
            <table>
                ...
                <tbody>
                    <?php
                            if (isset($_POST['save'])) {
                                $handleActor = $_POST['handleActor'];
                                $id = $_POST['id'];

                                // Kiểm tra nếu trường handleActor không trống
                                if (!empty($handleActor)) {
                                    try {
                                        // Sử dụng PDO để thực hiện truy vấn
                                        $pdo = new PDO("mysql:host=localhost;dbname=study-support", "root", "123");
                    ...
                    <tr>
                        ...
                        <td><?= $request->completionTime; ?></td>
                        <td><?= $request->fee; ?></td>
                        <td><?= $request->contact; ?></td>
                        <td><?= $request->schedule; ?></td>
                        <td><?= $request->timestamp; ?></td>
                        <td><?= substr($request->filePath, 0, 20) ?></td>
                        ...
                        <form action="" method="POST">
                            ...
                            <td style="display:flex; column-gap:10px">
                                ...
                                <button type="submit" name="save" style="border-radius:10px; border:none">
